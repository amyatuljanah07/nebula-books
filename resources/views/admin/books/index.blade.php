...
<head>
    ...
    <title>Books Management - NebulaBooks</title>
    <link rel="stylesheet" 
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="books-section">
           ...
           <form method="GET" action="{{ route('admin.books.index') }}" id="searchForm">
    <div class="filter-bar">
        ...
        @if(request()->hasAny(['search', 'category', 'status']))
            <a href="{{ route('admin.books.index') }}" class="btn-action btn-delete" style="padding: 12px 20px; text-decoration: none;">
                Clear
            </a>
        @endif
    </div>
                ...
                <tbody>
                    @forelse($books as $book)
                        <tr>
                            <td>
                                <div class="book-info">
                                    <img src="{{ $book->image ? asset('storage/' . $book->image) : 'https://via.placeholder.com/50x70' }}" 
                                         alt="{{ $book->title }}" 
                                         class="book-image">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 40px;">
                                <p style="color: #999;">No books found. <a href="{{ route('admin.books.create') }}">Add your first book</a></p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
