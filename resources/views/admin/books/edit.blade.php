...
<head>
    ...
    <title>Edit Book - NebulaBooks</title>
    <link rel="stylesheet" 
    ...
    <div class="main-content">
        ...
        <div class="form-section">
            <div class="form-header">
                ...
                <a href="{{ route('admin.books.index') }}" class="btn-back">← Back to List</a>
            </div>
            ...
            <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="sinopsis" name="sinopsis">{{ old('sinopsis', $book->sinopsis) }}</textarea>
                    @error('sinopsis')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="tahun_terbit" name="tahun_terbit" value="{{ old('tahun_terbit', $book->tahun_terbit) }}">
                        @error('tahun_terbit')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    @if($book->image)
                        <div class="current-image">
                            <p>Current image:</p>
                            <img src="{{ asset('storage/' . $book->image) }}" alt="{{ $book->title }}" style="max-width: 200px; border-radius: 5px; border: 2px solid #ddd;">
                        </div>
                    @endif
                    ...
                    <div class="image-preview" id="imagePreview" style="display: none;">
                        <p style="font-size: 12px; color: #666; margin-top: 10px;">New image preview:</p>
